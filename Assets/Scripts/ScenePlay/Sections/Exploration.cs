...
public class Exploration : MonoBehaviour
{
    ...
    public void ButtonExplorationNum()
    {
        if (PlayManager.Instance.Fund >= PlayManager.Instance.ExploreCost)
        {
            ...
            _explorationNumText.text = $"{LanguageManager.Instance["≈ΩªÁ ¿Â∫Ò"]} {PlayManager.Instance.ExploreNum.ToString()}";
    ...
    {
        _explorationNumText.text = $"{LanguageManager.Instance["≈ΩªÁ ¿Â∫Ò"]} {PlayManager.Instance.ExploreNum}";
        _explorationCostText.text = $"{LanguageManager.Instance["¿⁄±›"]} {PlayManager.Instance.ExploreNum.ToString()}";
    }
